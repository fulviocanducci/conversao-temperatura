...
app.get("/", (req, res) => {
  res.render("index", { valorConvertido: "", selectOption: 1, value: req.body.valorRef ?? "" });
});
...
app.post("/", (req, res) => {
  ...
  res.render("index", { valorConvertido: resultado, selectOption: +req.body.selectTemp, value: req.body.valorRef ?? "" });
});
